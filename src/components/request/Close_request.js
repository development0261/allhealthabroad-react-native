...
import {Picker, StyleSheet, FlatList, Image, View, ActivityIndicator, Text, StatusBar, Button} from 'react-native';
...
export default class Open_request extends Component{
    ...
    componentDidMount(){
        ...
        //console.log(auth);
        fetch("https://allaboardhealth.com/api/authentication/allcloserequests", {
        method: "POST",
        headers: headers,                
        body:  data
        })
                        ...
                        <Card title={item.company_name}>
                          <ScrollView>
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                              ...
                              <Text> : {item.request_status=="1" ? <Text style={{fontWeight: "bold",color:"red"}}>Open</Text> : <Text style={{fontWeight: "bold",color:"green"}}>Close</Text>}</Text>
                            </View>
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                            ...
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                              ...
                              <Text style={{width:240}}> : {item.when_question}</Text>
                            </View>
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                              <Text style={{fontWeight: "bold",color:"black"}}>Preferred Time </Text>
                              <Text style={{width:182}}> : {item.preferred_time}</Text>
                            </View>
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                            ...
                            <View style={{flexDirection:"row",paddingBottom:10}}>
                              ...
                              <Text style={{width:200}}> {item.extra}</Text>
                            </View>
                          </ScrollView>
                        </Card>
                    </View>}
