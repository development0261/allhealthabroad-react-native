...
export default class Refill_provider extends Component{  
    constructor(props){      
        super(props)
        this.state ={          
          user_id:"",
    ...
    refill_supply = (id,name,lastname,type) =>{
        var providername= name +' '+ lastname + ' '+ type;
        this.props.navigation.navigate('Refill_new_request',{Json_value:this.state.location_id,provider_id:this.state.provider_id,patient_id:this.state.patient_id,firstName:this.state.first_name,lastName:this.state.last_name,type:this.state.type,providerName:this.state.mainProviderName,locationName:this.state.location_name,subProvider_id:id,pharmacy_request:this.state.pharmacy_request,subProviderName:providername});
    }
    go_back(){
    ...
    componentDidMount(){
        ...
        const mainProviderName = navigation.getParam('providerName','No-Name');
        ...
        this.setState({location_id:location_id,provider_id:providerId,patient_id:patientId,first_name:FirstName,last_name:LastName,type:type,mainProviderName:mainProviderName,location_name:location,pharmacy_request:pharmacyRequest});
        ...
        console.log("mainProviderName:"+mainProviderName);
          ...
          <View style={styles.first_contanier}>              
            ...
            <FlatList                  
                ...
                <View style={{paddingBottom:10}}>
                    ...
                    <TouchableOpacity onPress={()=>this.refill_supply(item.id,item.first_name,item.last_name,item.type_name)}>
