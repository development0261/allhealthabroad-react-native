...
export default class Refill_supply extends Component{
    ...
    next_click(){
        ...
        this.props.navigation.navigate('Refill_extra',{Json_value:this.state.location_id,provider_id:this.state.provider_id,patient_id:this.state.patient_id,firstName:this.state.first_name,lastName:this.state.last_name,type:this.state.type,providerName:this.state.provider_name,locationName:this.state.location_name,pharmacy_request:this.state.pharmacy_request,medication_name:this.state.medication_name,pharmacyRequest:this.state.pharmacyRequest,subProvider_id:this.state.subProvider_id,under_supply:when_value,subProviderName:this.state.subProviderName});
    }
    go_back(){
        this.props.navigation.navigate('Refill_new_request');
    }
