...
export default class Select_provider extends Component{  
    ...
    componentDidMount(){
        ...
        this.setState({location_id:location_id,provider_id:providerId,patient_id:patientId,firstName:FirstName,lastName:LastName,type:type,provider_name:providername,location_name:location,pharmacyRequest:pharmacyRequest});
    ...
    return (          
        <View style={styles.container}>
          ...
          <View>            
            ...
            <Text style={styles.title}>Step 4 of 7</Text>
          </View>
          ...
          <ScrollView>
            <View style={styles.first_contanier}>              
              ...
              <Text style={{fontSize:20,color:'#0097a7',marginTop:10,marginBottom:10,textAlign:'center'}}>Which providers do you see at our practice?</Text>
              <FlatList
