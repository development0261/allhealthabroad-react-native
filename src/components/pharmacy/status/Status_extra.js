...
export default class Status_extra extends Component{
    constructor(props){      
        super(props)
        this.state ={
          isLoading: true,
    ...
    next_click(){
        ...
        console.log(this.state.provider_name);
        this.props.navigation.navigate('Status_verify',{Json_value:this.state.location_id,provider_id:this.state.provider_id,patient_id:this.state.patient_id,firstName:this.state.first_name,lastName:this.state.last_name,type:this.state.type,providerName:this.state.provider_name,locationName:this.state.location_name,pharmacy_request:this.state.pharmacy_request,subProvider_id:this.state.subProvider_id,status_extra:this.state.status_extra,subProviderName:this.state.subProviderName,medicine_name:this.state.medicine_name,medicine_related:this.state.medicine_related,under_supply:this.state.under_supply});
    }
    go_back(){
        this.props.navigation.navigate('Medicine_supply');
    }
                ...
                <View style={styles.first_contanier}>
                    ...
                    <View style={{marginTop:20,width:'100%'}}>
                        <TextInput
                            ...
                            multiline={true}
                            numberOfLines={10}
                            onChangeText={(status_extra) => this.setState({status_extra})}
                        />
                    </View>
                </View>
            </ScrollView>
